...
const Page = () => {
  ...
  return (
    <>
      ...
      <div className="package-details-area pt-0 mb-120 position-relative">
        <div className="">
          <div className="row">
        ...
        <div className="container">
          <div className="row g-xl-4 gy-5">
            <div className="col-xl-8">
              <h2>
                Experience 13 day excitement with the scenic activities
                in Sri Lanka
              </h2>
              ...
              <div className="row mb-50">
                ...
                <div className="col-lg-2">
                  ...
                  <div className={`w-100 p-2 ${sTab === 1 ? "bg-dark text-white" : "bg-light text-dark"}   text-center`}
                    style={{
                      cursor: "pointer"
                    }}
                    onClick={() => {
                ...
                <div className="col-lg-2">
                  ...
                  <div className={`w-100 p-2 ${sTab === 2 ? "bg-dark text-white" : "bg-light text-dark"}   text-center`}
                    style={{
                      cursor: "pointer"
                    }}
                    onClick={() => {
                ...
                <div className="col-lg-2">
                  ...
                  <div className={`w-100 p-2 ${sTab === 3 ? "bg-dark text-white" : "bg-light text-dark"}   text-center`}
                    style={{
                      cursor: "pointer"
                    }}
                    onClick={() => {
                ...
                <div className="col-lg-2">
                  ...
                  <div className={`w-100 p-2 ${sTab === 4 ? "bg-dark text-white" : "bg-light text-dark"}   text-center`}
                    style={{
                      cursor: "pointer"
                    }}
                    onClick={() => {
                ...
                <div className="col-lg-2">
                  ...
                  <div className={`w-100 p-2 ${sTab === 5 ? "bg-dark text-white" : "bg-light text-dark"}   text-center`}
                    style={{
                      cursor: "pointer"
                    }}
                    onClick={() => {
